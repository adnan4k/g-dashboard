        ...
        <ul id="navbar-nav" class="navbar-nav ">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'sliders' ? 'bg-[#56C596] text-white font-bold rounded-2xl' : ''); ?>"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg class="<?php echo e(request()->routeIs('slider') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('sliders') ? 'fill:black;' : 'fill: black;'); ?>"
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'contact' ? 'bg-[#56C596] text-white font-bold rounded-2xl' : ''); ?>"
                    ...
                    <div
                        ...
                        <svg class="<?php echo e(request()->routeIs('contact') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('contact') ? 'fill:black;' : 'fill: black;'); ?>"
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'testimonials' ? 'bg-[#56C596] text-white font-bold rounded-2xl' : ''); ?>"
                    ...
                    <div
                        ...
                        <svg class="<?php echo e(request()->routeIs('testimonials') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('testimonials') ? 'fill:black;' : 'fill: black;'); ?>"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path
                                d="M96 0C60.7 0 32 28.7 32 64l0 384c0 35.3 28.7 64 64 64l288 0c35.3 0 64-28.7 64-64l0-384c0-35.3-28.7-64-64-64L96 0zM208 288l64 0c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16l-192 0c-8.8 0-16-7.2-16-16c0-44.2 35.8-80 80-80zm-32-96a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zM512 80c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64zM496 192c-8.8 0-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64c0-8.8-7.2-16-16-16zm16 144c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64z" />
                        </svg>
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'booking' ? 'bg-[#56C596] text-white font-bold rounded-2xl' : ''); ?>"
                    ...
                    <div
                        ...
                        <svg class="<?php echo e(request()->routeIs('booking') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('booking') ? 'fill:black;' : 'fill: black;'); ?>"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path
                                d="M96 0C60.7 0 32 28.7 32 64l0 384c0 35.3 28.7 64 64 64l288 0c35.3 0 64-28.7 64-64l0-384c0-35.3-28.7-64-64-64L96 0zM208 288l64 0c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16l-192 0c-8.8 0-16-7.2-16-16c0-44.2 35.8-80 80-80zm-32-96a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zM512 80c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64zM496 192c-8.8 0-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64c0-8.8-7.2-16-16-16zm16 144c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64z" />
                        </svg>
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'sections' ? 'bg-[#56C596] text-white font-bold rounded-2xl' : ''); ?>"
                    ...
                    <div
                        ...
                        <svg class="<?php echo e(request()->routeIs('sections') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('sections') ? 'fill:black;' : 'fill: black;'); ?>"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path
                                d="M96 0C60.7 0 32 28.7 32 64l0 384c0 35.3 28.7 64 64 64l288 0c35.3 0 64-28.7 64-64l0-384c0-35.3-28.7-64-64-64L96 0zM208 288l64 0c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16l-192 0c-8.8 0-16-7.2-16-16c0-44.2 35.8-80 80-80zm-32-96a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zM512 80c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64zM496 192c-8.8 0-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64c0-8.8-7.2-16-16-16zm16 144c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64z" />
                        </svg>
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'subscription' ? 'bg-[#56C596] text-white font-bold rounded-2xl' : ''); ?>"
                    ...
                    <div
                        ...
                        <svg class="<?php echo e(request()->routeIs('subscription') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('subscription') ? 'fill:black;' : 'fill: black;'); ?>"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path
                                d="M96 0C60.7 0 32 28.7 32 64l0 384c0 35.3 28.7 64 64 64l288 0c35.3 0 64-28.7 64-64l0-384c0-35.3-28.7-64-64-64L96 0zM208 288l64 0c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16l-192 0c-8.8 0-16-7.2-16-16c0-44.2 35.8-80 80-80zm-32-96a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zM512 80c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64zM496 192c-8.8 0-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64c0-8.8-7.2-16-16-16zm16 144c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64z" />
                        </svg>
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'tour' ? 'bg-[#56C596] text-white font-bold rounded-2xl' : ''); ?>"
                    wire:navigate href="<?php echo e(route('tour')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">

                        <svg class="<?php echo e(request()->routeIs('tour') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('tour') ? 'fill:black;' : 'fill: black;'); ?>"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path
                                d="M96 0C60.7 0 32 28.7 32 64l0 384c0 35.3 28.7 64 64 64l288 0c35.3 0 64-28.7 64-64l0-384c0-35.3-28.7-64-64-64L96 0zM208 288l64 0c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16l-192 0c-8.8 0-16-7.2-16-16c0-44.2 35.8-80 80-80zm-32-96a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zM512 80c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64zM496 192c-8.8 0-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64c0-8.8-7.2-16-16-16zm16 144c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64z" />
                        </svg>
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'schedule' ? 'bg-[#56C596] text-white font-bold rounded-2xl' : ''); ?>"
                    wire:navigate href="<?php echo e(route('schedule')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">

                        <svg class="<?php echo e(request()->routeIs('schedule') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('schedule') ? 'fill:black;' : 'fill: black;'); ?>"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path
                                d="M96 0C60.7 0 32 28.7 32 64l0 384c0 35.3 28.7 64 64 64l288 0c35.3 0 64-28.7 64-64l0-384c0-35.3-28.7-64-64-64L96 0zM208 288l64 0c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16l-192 0c-8.8 0-16-7.2-16-16c0-44.2 35.8-80 80-80zm-32-96a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zM512 80c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64zM496 192c-8.8 0-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64c0-8.8-7.2-16-16-16zm16 144c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64z" />
                        </svg>
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'profile' ? 'bg-[#56C596] text-white font-bold rounded-2xl' : ''); ?>"
                    wire:navigate href="<?php echo e(route('profile')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">

                        <svg class="<?php echo e(request()->routeIs('profile') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('profile') ? 'fill:black;' : 'fill: black;'); ?>"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path
                                d="M96 0C60.7 0 32 28.7 32 64l0 384c0 35.3 28.7 64 64 64l288 0c35.3 0 64-28.7 64-64l0-384c0-35.3-28.7-64-64-64L96 0zM208 288l64 0c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16l-192 0c-8.8 0-16-7.2-16-16c0-44.2 35.8-80 80-80zm-32-96a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zM512 80c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64zM496 192c-8.8 0-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64c0-8.8-7.2-16-16-16zm16 144c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 64c0 8.8 7.2 16 16 16s16-7.2 16-16l0-64z" />
                        </svg>
