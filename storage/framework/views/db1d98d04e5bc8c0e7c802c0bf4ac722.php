<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 z-0 fixed-start ms-3 " id="sidenav-main">
    ...
    <div id="sidebar-container" class="z-999 md:z-0">
        <ul id="navbar-nav" class="navbar-nav ">
            ...
            <li class="nav-item">
                <a wire:navigate class="nav-link <?php echo e(Route::currentRouteName() == 'category' ? 'bg-[#56C596] text-white font-bold rounded-2xl' : ''); ?>"
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'blogs' ? 'bg-[#56C596] text-white font-bold rounded-2xl' : ''); ?>"
                    wire:navigate href="<?php echo e(route('blogs')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg
                            class="<?php echo e(request()->routeIs('blogs') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('blogs') ? 'fill: black;' : 'fill: black;'); ?>"
...
</aside><?php /**PATH C:\Users\Administrator\Desktop\apps\t-dashboard\resources\views/layouts/navbars/auth/sidebar.blade.php ENDPATH**/ ?>